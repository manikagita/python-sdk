...
class NaturalLanguageUnderstandingV1(WatsonDeveloperCloudService):
    ...
    def analyze(self,
        ...
        :rtype: watson_developer_cloud.natural_language_understanding_v1.AnalysisResults
        """
        if features is None:
    ...
    def list_models(self):
        ...
        :rtype: watson_developer_cloud.natural_language_understanding_v1.ListModelsResults
        """
        params = {'version': self.version}
        response = self.request(
